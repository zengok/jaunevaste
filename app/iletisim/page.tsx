        ...
        <Container className="grid gap-8 lg:grid-cols-5">
          <div className="space-y-4 lg:col-span-2">
            ...
            >
              ...
              <p className="mt-2 text-sm text-ink/60">{site.email}</p>
              <span className="mt-3 inline-block text-sm font-bold text-gold">
                E-posta gönder →
              </span>
            </a>
            ...
            */}
            ...
            >
              ...
              <p className="text-xs text-ink/45 sm:col-span-2">
                Formu göndererek{" "}
                <a href="/kvkk" className="text-gold hover:underline">
              ...
              <button
                type="submit"
                className="rounded-full bg-jaune-500 px-8 py-3.5 text-sm font-bold text-ink shadow-soft transition-all hover:bg-jaune-400 hover:shadow-lift sm:col-span-2 sm:justify-self-start"
              >
                Mesajı Gönder
              </button>
            </form>
