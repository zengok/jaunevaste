    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="rounded-full bg-primary px-5 py-2.5 text-sm font-bold text-white shadow-soft hover:bg-primary-hover"
        >
          + Yeni Ürün
        </Link>
      </div>
            ...
            {products.map((product) => {
              ...
              return (
                <tr key={product.id} className="border-b border-hairline last:border-0">
                  ...
                  <td className="px-5 py-3 text-muted">{category?.name ?? "—"}</td>
                  ...
                  <td className="px-5 py-3">
                    {warnings.length === 0 ? (
                      <span className="text-xs font-semibold text-success">Sorun yok</span>
                    ) : (
                  ...
                  <td className="whitespace-nowrap px-5 py-3 text-right">
                    ...
                    <Link
                      ...
                      target="_blank"
                      className="ml-3 text-xs font-bold text-muted hover:underline"
                    >
                      Sitede gör ↗
                    </Link>
