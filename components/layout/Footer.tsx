...
export function Footer() {
  return (
    <footer className="mt-auto border-t border-ink/5 bg-cream">
      <Container className="py-12 sm:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p className="font-display text-2xl font-bold text-ink">
              Jaune <span className="text-gold">Vaste</span>
            </p>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-cocoa shadow-soft transition-colors hover:text-gold"
              >
              ...
              <a
                ...
                className="flex h-10 items-center justify-center rounded-full bg-white px-4 text-sm font-semibold text-cocoa shadow-soft transition-colors hover:text-gold"
              >
                Trendyol Mağazamız
              </a>
            </div>
          ...
          {footerColumns.map((col) => (
            <div key={col.title}>
              <h3 className="text-sm font-bold uppercase tracking-widest text-cocoa">
                {col.title}
              </h3>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-ink/10 pt-6 text-xs text-ink/50 sm:flex-row sm:items-center sm:justify-between">
          <p>
